        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="w-120 rounded-xl bg-white p-8 text-gray-900 shadow-lg">
                ...
                <form className="mt-6 space-y-4">
                    ...
                    <div className="text-sm">
                        ...
                        <input
                            type="text"
                            id="username"
                            className="w-full rounded-md border border-gray-300 bg-white px-4 py-3 text-gray-900 outline-none focus:border-violet-400 focus:ring focus:ring-violet-200"
                        />
                    </div>
                    ...
                    <div className="text-sm">
                        ...
                        <div className="mt-2 flex justify-end text-xs text-gray-500">
                            <a href="#" className="hover:underline hover:text-violet-500">
                                Forgot Password ?
                            </a>
                        </div>
                    </div>
                ...
                <p className="mt-6 text-center text-xs text-gray-500">
                    ...
                    <a href="#" className="text-violet-500 hover:underline hover:text-violet-600">
                        Sign up
                    </a>
                </p>
            </div>
